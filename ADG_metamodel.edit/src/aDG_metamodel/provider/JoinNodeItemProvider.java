...
/**
 * This is the item provider adapter for a {@link aDG_metamodel.JoinNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JoinNodeItemProvider extends NodeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JoinNode_ID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JoinNode_ID_feature", "_UI_JoinNode_type"),
				 ADG_metamodelPackage.Literals.JOIN_NODE__ID,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(JoinNode.class)) {
			case ADG_metamodelPackage.JOIN_NODE__ID:
