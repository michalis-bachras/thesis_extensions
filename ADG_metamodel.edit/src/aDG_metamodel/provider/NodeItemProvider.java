...
/**
 * This is the item provider adapter for a {@link aDG_metamodel.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_number_feature", "_UI_Node_type"),
				 ADG_metamodelPackage.Literals.NODE__NUMBER,
				 true,
				 false,
				 false,
	...
	protected void addThreadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_thread_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_thread_feature", "_UI_Node_type"),
				 ADG_metamodelPackage.Literals.NODE__THREAD,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ADG_metamodelPackage.Literals.NODE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
