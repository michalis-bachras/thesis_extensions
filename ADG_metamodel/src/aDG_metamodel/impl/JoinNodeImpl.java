 ...
 * </p>
 * <ul>
 *   <li>{@link aDG_metamodel.impl.JoinNodeImpl#getID <em>ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinNodeImpl extends NodeImpl implements JoinNode {
	...
	protected EClass eStaticClass() {
		return ADG_metamodelPackage.Literals.JOIN_NODE;
	}
	...
	public void setID(int newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ADG_metamodelPackage.JOIN_NODE__ID, oldID, id));
	}
