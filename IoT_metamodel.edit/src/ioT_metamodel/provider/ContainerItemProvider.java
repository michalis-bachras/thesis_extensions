...
/**
 * This is the item provider adapter for a {@link ioT_metamodel.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IoT_metamodelPackage.Literals.CONTAINER__ID,
				 true,
				 false,
				 false,
	...
	protected void addIP_addressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_IP_address_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_IP_address_feature", "_UI_Container_type"),
				 IoT_metamodelPackage.Literals.CONTAINER__IP_ADDRESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
