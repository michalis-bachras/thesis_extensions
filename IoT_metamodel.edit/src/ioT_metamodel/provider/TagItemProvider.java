...
/**
 * This is the item provider adapter for a {@link ioT_metamodel.Tag} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TagItemProvider extends DeviceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IoT_metamodelPackage.Literals.TAG__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIdentifiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tag_identifies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tag_identifies_feature", "_UI_Tag_type"),
				 IoT_metamodelPackage.Literals.TAG__IDENTIFIES,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Tag.class)) {
			case IoT_metamodelPackage.TAG__NAME:
