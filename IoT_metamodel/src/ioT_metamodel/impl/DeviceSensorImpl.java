...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Device Sensor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ioT_metamodel.impl.DeviceSensorImpl#getSensor_actions <em>Sensor actions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceSensorImpl extends SensorImpl implements DeviceSensor {
	/**
	...
	protected EClass eStaticClass() {
		return IoT_metamodelPackage.Literals.DEVICE_SENSOR;
	}
	...
	public EList<Action> getSensor_actions() {
		if (sensor_actions == null) {
			sensor_actions = new EObjectResolvingEList<Action>(Action.class, this, IoT_metamodelPackage.DEVICE_SENSOR__SENSOR_ACTIONS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IoT_metamodelPackage.DEVICE_SENSOR__SENSOR_ACTIONS:
