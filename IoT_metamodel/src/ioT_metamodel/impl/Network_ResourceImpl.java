 ...
 * </p>
 * <ul>
 *   <li>{@link ioT_metamodel.impl.Network_ResourceImpl#getContains_device_resource <em>Contains device resource</em>}</li>
 *   <li>{@link ioT_metamodel.impl.Network_ResourceImpl#getContains_service_resource <em>Contains service resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Network_ResourceImpl extends InformationResourceImpl implements Network_Resource {
	/**
	 ...
	 * @generated
	 */
	protected Network_ResourceImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IoT_metamodelPackage.Literals.NETWORK_RESOURCE;
	}
	...
	public EList<Device_Resource> getContains_device_resource() {
		if (contains_device_resource == null) {
			contains_device_resource = new EObjectContainmentEList<Device_Resource>(Device_Resource.class, this, IoT_metamodelPackage.NETWORK_RESOURCE__CONTAINS_DEVICE_RESOURCE);
		}
	...
	public EList<Service_Resource> getContains_service_resource() {
		if (contains_service_resource == null) {
			contains_service_resource = new EObjectContainmentEList<Service_Resource>(Service_Resource.class, this, IoT_metamodelPackage.NETWORK_RESOURCE__CONTAINS_SERVICE_RESOURCE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IoT_metamodelPackage.NETWORK_RESOURCE__CONTAINS_DEVICE_RESOURCE:
				return ((InternalEList<?>)getContains_device_resource()).basicRemove(otherEnd, msgs);
			case IoT_metamodelPackage.NETWORK_RESOURCE__CONTAINS_SERVICE_RESOURCE:
