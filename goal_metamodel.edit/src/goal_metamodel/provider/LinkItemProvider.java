...
/**
 * This is the item provider adapter for a {@link goal_metamodel.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider extends ContextualComponentItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_available_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_available_feature", "_UI_Link_type"),
				 Goal_metamodelPackage.Literals.LINK__AVAILABLE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Link_type") + " " + link.isContext_enabled();
	}
